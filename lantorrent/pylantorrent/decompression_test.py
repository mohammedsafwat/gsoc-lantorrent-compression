...
class DecompressionTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.src_file = "/home/mohammed/Desktop/output.txt.bz2"
    ...
    def test_decompression(self):   
        ...
        final = endpoint.create_endpoint_entry(self.host, ["/home/mohammed/Desktop/op.bz2"], self.src_size, self.compress_input, self.compression_type, rename=False)
