...
class DecompressionTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.src_file = "/home/mohammed/Desktop/one.txt.bz2"
    ...
    def test_decompression(self):
        ...
        final = endpoint.create_endpoint_entry(self.host, self.client_files_a, ["/home/mohammed/Desktop/second_decompression_test.txt"], self.src_size, self.compress_input, self.compression_type, rename=False)
